...
// pre engagement
export const ACTION_CHANGE_PRE_ENGAGEMENT_PHASE = "ACTION_CHANGE_PRE_ENGAGEMENT_PHASE";
export const ACTION_UPDATE_PRE_ENGAGEMENT_NEW_BOOKING_DATA = "ACTION_UPDATE_PRE_ENGAGEMENT_NEW_BOOKING_DATA";
export const ACTION_UPDATE_PRE_ENGAGEMENT_EXISTING_BOOKING_DATA = "ACTION_UPDATE_PRE_ENGAGEMENT_EXISTING_BOOKING_DATA";
export const ACTION_UPDATE_PRE_ENGAGEMENT_GROUP_BOOKING_DATA = "ACTION_UPDATE_PRE_ENGAGEMENT_GROUP_BOOKING_DATA";
export const ACTION_UPDATE_PRE_ENGAGEMENT_OTHER_QUERY_DATA = "ACTION_UPDATE_PRE_ENGAGEMENT_OTHER_QUERY_DATA";
